...
def split_text(
    ...
    paired_lines = []
    for i in range(0, len(lines), lines_per_entry):
    ...
    ls_cluster = []
    for i in range(0, len(paired_lines), num_line_per_cluster):
        cluster = paired_lines[i:i + num_line_per_cluster]
